...
<html lang="en">
<head>
    <title>Code coverage report for node-mhtml/lib/partCollection.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">node-mhtml/lib/partCollection.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">node-mhtml/lib/</a> &#187; partCollection.js</div>
</div>
<div class="body">
...
&nbsp;
    var dirname;
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (!(part instanceof Part)) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid part');</span>
    }
&nbsp;
