...
module.exports = function createLintFunction(userOpts) {
  ...
  var reportErrors = function (file, out, cfg) {
	...
	//Logger: logs file path
	filePathHTML = '';
	filePathHTML += '<p><span style="font-family:courier new,courier,monospace;">';
	filePathHTML += filePath;
	filePathHTML += '</span></p><p>&nbsp;</p>';
	fs.appendFile('Dist/jshintLog.html', filePathHTML);
